 ...
 */
public class SportFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<NewsInfo>>{

    private static final int NEWS_LOADER_ID = 0;
    private static final String SPORT_URL = "https://content.guardianapis.com/search?section=sport&show-fields=thumbnail&api-key=00d9a257-1ff3-4d33-bff4-b26e08cd141d";
    ...
    public Loader<List<NewsInfo>> onCreateLoader(int id, Bundle args) {
        return new NewsLoader(getContext(), SPORT_URL);
    }
