...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class NewsPreferenceSettings extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        private void newsPreferenceSummary(Preference preference) {
